...
def espacePersonnel() :
    ...
    return {"title" : "Espace personnel", "titre" : "", "menu_principal" : baliseMenu(6, 6), "qui" : cestQui(), "menu" : baliseMenu(8, 3), "contenu" : contenu, "pied_de_page" : baliseMenu(7, 4)}
...
def edition(tache) :
    ...
    curseur.close()
    branche.close()
    return {"title" : "", "titre":"Modification de mes données personnelles","menu_principal":baliseMenu(6, 6),"menu" :"","qui":cestQui(),"contenu":contenu,"pied_de_page":baliseMenu(7, 4)}
...
def choix(tache) :
    ...
    if request.forms.modifier :
        ...
        return {"title" : "", "titre" : "Publication d'un article", "menu_principal" : baliseMenu(6, 6), "qui" : cestQui(), "menu" : "", "contenu" : contenu, "pied_de_page" : baliseMenu(7, 4)} 
    ...
    return {"title" : "", "titre" : tititre, "menu_principal" : baliseMenu(6, 6), "qui" : cestQui(), "menu" : "", "contenu" : contenu, "pied_de_page" : baliseMenu(7, 4)}
